...
class hadoop ($hadoop_security_authentication = "simple",
  ...
  $proxyusers = {
      hue => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
    oozie => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
     hive => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
   httpfs => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" } },
