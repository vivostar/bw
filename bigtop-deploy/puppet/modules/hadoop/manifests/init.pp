...
class hadoop ($hadoop_security_authentication = "simple",
  ...
  $proxyusers = {
     hues => { groups => 'hudson,hue,hues,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
      hue => { groups => 'hudson,hue,hues,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
    oozie => { groups => 'hudson,hue,hues,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
     hive => { groups => 'hudson,hue,hues,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" },
   httpfs => { groups => 'hudson,hue,hues,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users', hosts => "*" } },
