...
class hadoop ($hadoop_security_authentication = "simple",
  ...
  $proxyusers = {
    spark => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,spark', hosts => "*" },
      hue => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,spark', hosts => "*" },
    oozie => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,spark', hosts => "*" },
     hive => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,spark', hosts => "*" },
   httpfs => { groups => 'hudson,hue,testuser,root,hadoop,jenkins,oozie,hive,httpfs,users,spark', hosts => "*" } },
